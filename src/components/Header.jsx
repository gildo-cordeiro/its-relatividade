    ...
    <header className="app-header">
      <div className="header-left">
        ...
        <div>
          ...
          <p className="header-sub">Sistema de Tutoria Inteligente · IMD0511 IAED 2026.1</p>
        </div>
      </div>
      <div className="header-right" style={{ display: "flex", alignItems: "center", gap: "10px" }}>
        <button onClick={onReset} className="btn-reset" title="Reiniciar todo o progresso">
